...
*crude_mod_mh: depression ~ sex + children.* 
...
*mod2_mh: depression ~ sex + children + race + age + marital_status* 
...
*mod3_mh: depression ~ sex + children + race + age + marital_status + education + income + employment*
...
*full_mod_mh: depression ~ sex + children + race + age + marital_status + education + income + employment + general_health + exercise*
...
Here we are interested in our second exposure, the number of children in the household. Specifically, we are interested in if it affects the self-reported number of days with bad mental health days differently for men and women. 
