---
title: "Mental health opinion service utilization by gender"
author: ""
date: ""
output: 
  html_document:
...
One main takeway from these findings is that fear of public stigma is probably not one of the reasons why men have lower mental health service utlization than women, at least not a major one. More importantly, these findings raise new questions. For example,

* Why do men seek mental health services less than women? Is this related to better self-reported mental health outcomes among men (e.g., less professional help, less disgnoses, less self reports)?
