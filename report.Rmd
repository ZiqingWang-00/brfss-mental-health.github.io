...
#### Respondent-level analysis: Recent frequency of bad mental health 
...
We found that the WPS index is negatively associated with the prevalence of self-reported depression and the average number of days mental health not good in the past 30 days, before and after adjusting per-capita GDP. This indicates that the higher women's status in the state, the lower the state-level prevalence of self-reported depression and >15 days mental health not good recently among women. Details and numbers are [here](https://ziqingwang-00.github.io/brfss-mental-health.github.io/ecological.html).
...
Another next step is to find the effect of belief, attitude, and behavior factors on self-reported mental health outcomes. Understanding the reasons behind the gender differences in self-reported mental health outcomes help ensure the disparity truely exists and informs public health actions to target vulnerable groups.  
