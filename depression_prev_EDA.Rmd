...
Based on the plot and test result above, it seems that, for women, the prevalence of self-reported depression remains stable between age group 30-49 and 50-64, but decreases significantly when entering the age group of 30-49 as well as the group of 65+. The same trend is also displayed in men but with smaller magnitude in changes.  
