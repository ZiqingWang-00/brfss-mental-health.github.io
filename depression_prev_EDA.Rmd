...
We can see that not only is the prevalence of self-reported depression higher in women than men, the same seems to hold true for all race/ethnicities included in the data set. Below is the p-values of the chi-squared test we did seperately for women and men to verify this observation:
