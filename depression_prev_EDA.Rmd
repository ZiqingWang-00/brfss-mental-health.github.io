...
One interesting observation is that men who have children in the household have noticeably lower prevalence of self-reported depression while women who have children don't. We do a chi-square test incorporating the survey weights to verify this observation:
...
As expected, based on the chi-squared test, self-reported depression is significantly associated with the number of children in the household among men but not women. 
...
We can see that not only is the prevalence of self-reported depression higher in women than men, the same holds true for all race/ethnicities included in the data set. This is the result of the chi-squared test we did to verify this observation:
